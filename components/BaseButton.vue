<template>
    <button type="button" @click="click" @mouseenter="enter" @mouseleave="leave"
        class="btn relative h-[6rem] rounded-full bg-black inline-flex flex-col items-center justify-center leading-none text-center overflow-hidden uppercase text-18 px-50 pointer-cursor rotate-[-7deg]">
